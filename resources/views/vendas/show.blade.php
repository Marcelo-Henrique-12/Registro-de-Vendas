            ...
            <div class="position-relative overflow-hidden text-center banner-custon">
                <div class="container custon-container">
                    <div class="cadastro-section mb-5">
                        <h5 class="modal-title" id="modalGanhosLabel">Editar Venda</h5>
                        <p class="text-danger">* Campo obrigatório</p>
                    </div>
                    <form method="POST" class="form-template" action="{{ route('venda.update', $venda->id) }}">
                        @method('PUT')
                        @CSRF
                        <div class="form-group">
                            ...
                            <div class="card card-secondary card-outline" id="produtosSelecionados">
                                <div class="card-body table-responsive p-0">
                                    ...
                                    <table class="table table-bordered table-striped table-sm dataTable dtr-inline">
                                        <thead>
                                            <tr>
                                                <th colspan="7" style="text-align: center">Produtos Selecionados</th>
                                            </tr>
                                            <tr>
                                                <th>Id do Produto</th>
                                                <th>Nome</th>
                                        ...
                                        <tbody>
                                            @foreach ($venda->produtos as $produto)
                                                <tr>
                                                    ...
                                                    <td>{{ $produto->valor }}</td>
                                                    <td>{{ $produto->valor* $produto->pivot->quantidade }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <div class="form-group col-md-4">
                                    <div class="floating-label">
                                        <input type="number" name="quantidade_parcelas" id="quantidade_parcelas"
                                            ...
                                            value="{{ old('quantidade_parcelas', $quantidade_parcelas) }}" disabled />
                                ...
                                @foreach ($venda->parcelas as $parcela )
                                    ...
                                    <div class="row mb-5 d-flex align-items-center">
                                        <div id="createparcelas"
                                            ...
                                            style="width: 50px;height: 50px; margin-left:20px">{{$parcela->numero_parcela}}</div>

                                        <div class="form-group col-md-3">
                                            <div class="floating-label">
                                                <input type="date" name="data_parcela" id="data_parcela"
                                                    class="form-control @error('data_parcela') is-invalid @enderror"
                                                    value="{{ $parcela->data_vencimento }}" disabled/>
                                                <label for="data_parcela">Data do Vencimento</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <div class="floating-label">
                            ...
                            <div class="form-group form-button mt-5">
                                <a href="{{ route('venda.index')}}" class="btn custon-button-2">Voltar</a>
                            </div>
                        </div>
                </div>
                </form>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                @foreach ($venda->produtos as $produto)
                    produtosSelecionados.push({
                        ...
                        quantidade_produto: {{ $produto->pivot->quantidade }},
                        valor: {{ $produto->valor }},
                        subtotal: {{ $produto->valor * $produto->pivot->quantidade }}
                    });
                @endforeach
                ...
                @foreach ($venda->parcelas as $parcela)
                    parcelas.push({
                        ...
                        data_parcela: "{{ $parcela->data_vencimento }}",
