    ...
    @push('scripts')
        <script>
            ...
            function atualizaTabela(produtosSelecionados) {
                ...
                var produtosSelecionados = document.querySelector('#produtosSelecionados');
                produtosSelecionados.appendChild(inputProdutos);
                produtosSelecionados.appendChild(inputTotal);
